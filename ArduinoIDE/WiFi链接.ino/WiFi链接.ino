...
void setup(void){
  ...
  wifiMulti.addAP("ChinaNet-7DDF48", "zyy15101858135c");  // 通过调用函数addAP来记录3个不同的WiFi网络信息。
  wifiMulti.addAP("ChinaNet-7DDF48-5G", "87654321"); 
...
void handleRoot() {   //处理网站根目录“/”的访问请求 
  esp8266_server.send(200, "text/plain", "Hello World! Here is the ESP8266 development board");   // NodeMCU将调用此函数。
}
