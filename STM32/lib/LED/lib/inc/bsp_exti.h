...
#if 0
#define Choose_GPIO_Prot                            RCC_APB2Periph_GPIOA    //时钟
#define Choose_GPIO_Mode                            GPIO_Mode_IPU           //模式
#define Choose_GPIO_Pin                             GPIO_Pin_0              //端口
#define Choose_GPIO_Speed                           GPIO_Speed_50MHz        //速度
